...
COMPONENTS=(
    "https://github.com/comfyanonymous/ComfyUI-frontend-package"
    "https://github.com/comfyanonymous/ComfyUI-workflow-templates"
    "https://github.com/comfyanonymous/ComfyUI-embedded-docs"
)
